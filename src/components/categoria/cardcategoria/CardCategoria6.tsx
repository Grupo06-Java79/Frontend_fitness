...
export default function CardExercicio() {
    ...
    return (
        <div className="w-full max-w-sm bg-white rounded-lg shadow-lg overflow-hidden">
            {/* Imagem do treino */}
            <img 
                src="https://img.freepik.com/fotos-premium/retrato-de-uma-mulher-sorridente-se-exercitando-em-um-parque-da-cidade_1048944-11612258.jpg?w=1380" 
            ...
            <div className="p-4">
                ...
                <button 
                    ...
                    onClick={() => navigate('/listacategorias/Aquecimento')}
>
                        Saiba mais
                </button>
            </div>
