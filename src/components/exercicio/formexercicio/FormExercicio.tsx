...
function FormExecicio() {
    ...
    return (
        <div className="container flex flex-col items-center justify-center mx-auto">
            ...
            <form className="w-1/2 flex flex-col gap-4" onSubmit={gerarNovoExercicio}>
                <div className="flex flex-col gap-2">
                    <label htmlFor="descricao">Descrição do Exercício</label>
                    <input
                        type="text"
                        placeholder="Descreva aqui seu exercício"
                        name='descricao'
